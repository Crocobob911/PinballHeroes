...
namespace Editor
{
    public class CSVManager : MonoBehaviour{
        private static string csvFolderPath = "Assets/GameData/CSVs/"; // csv 파일들
        private static string soScriptPath = "Assets/Script/ScriptableObject/"; // object 클래스들 경로
        private static string soAssetPath = "Assets/Resources/ScriptableObjects/"; // object 객체들 경로
